...
'.prf-dd-item { display:flex;align-items:center;gap:10px;padding:10px 16px;font-family: "EB Garamond ",:14px;color:#f5eed8;cursor:pointer;transition:all 0.15s;text-decoration:none;border-bottom:1px solid #1c1c1c; }',
